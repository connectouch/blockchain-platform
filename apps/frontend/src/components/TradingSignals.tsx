      ...
      if (pricesData && Object.keys(pricesData).length > 0) {
        ...
        const realTimeSignals: TradingSignal[] = [
          ...
          },
          {
            ...
            action: 'BUY',
            confidence: 89,
            currentPrice: pricesData.data.chainlink?.usd || 25,
            targetPrice: (pricesData.data.chainlink?.usd || 25) * 1.15,
            stopLoss: (pricesData.data.chainlink?.usd || 25) * 0.90,
            timeframe: '5d',
          ...
          },
          {
            ...
            action: 'SELL',
            confidence: 78,
            currentPrice: pricesData.data.cardano?.usd || 0.45,
            targetPrice: (pricesData.data.cardano?.usd || 0.45) * 0.88,
            stopLoss: (pricesData.data.cardano?.usd || 0.45) * 1.05,
            timeframe: '24h',
